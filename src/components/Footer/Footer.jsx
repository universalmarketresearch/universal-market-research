...
import { FaMapLocation, FaPhone, FaWhatsapp, FaXTwitter } from "react-icons/fa6";
        ...
        <div className="lg:flex">
          <div className="-mx-6 w-full lg:w-2/5">
            <div className="px-6">
              ...
              <div className="flex items-center mt-2 gap-2 text-gray-600">
                ...
                <span className="block text-sm">99 S.t Jomblo Park Pekanbaru 28292. Indonesia</span>
              </div>
              <div className="flex items-center mt-2 gap-2 text-gray-600">
                <FaPhone className="text-sm" />
                <span className="block text-sm">+1 526 654 8965</span>
              </div>
              <div className="flex items-center mt-2 gap-2 text-gray-600">
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <div>
                <h3 className="uppercase text-gray-700">Industry Verticals</h3>
              ...
              <div>
                <h3 className="uppercase text-gray-700">Social</h3>
